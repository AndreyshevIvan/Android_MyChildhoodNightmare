...
const PhysicsMaterial PLAYER_MATERIAL = PhysicsMaterial(300, 0, 1);

const int PLAYER_BODY_BORDER = 5;
...
void CPlayer::CreatePlayerBody(const Vec2 &spawnPos)
{
	...
	m_body = PhysicsBody::createEdgeBox(PLAYER_BODY_SIZE, PLAYER_MATERIAL, PLAYER_BODY_BORDER);
